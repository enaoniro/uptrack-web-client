...
const GroupContextProvider = (props) => {
  ...
  const getGroupList = async () => {
    const response = await fetch("https://upt-orl5.onrender.com/groups");
  ...
  const addGroup = async (pGroup, id) => {
    ...
    try {
        const res = await fetch("https://upt-orl5.onrender.com/groups", {
        method: "POST",
  ...
  const updateGroup = async (pGroup) => {
    try {
      await fetch("https://upt-orl5.onrender.com/groups/" + pGroup.id, {
        method: "PUT",
  ...
  const deleteGroup = async (pGroupId) => {
    try {
      await fetch("https://upt-orl5.onrender.com/groups/" + pGroupId, {
        method: "DELETE",
      });
