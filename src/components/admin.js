          ...
          <div className="row align-items py-3" id="innerdiv">
            <div className="col-md-2">
              <div
                ...
                id="listebox"
              >
                <div className="w-100 bg-primary d-flex align-content-center justify-content-center"><h5 className="text-white bg-primary">CANTONS</h5></div>
                <div>
                  <ListGroup>
                    ...
                    {canton}
                      ...
                      <button className="btn bg-success text-white btn-outline-success" type="button" onClick={()=> setIsOpen(true)}>ADD canton</button>
              </div>
            </div>
